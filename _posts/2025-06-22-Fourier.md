...
تعد سلاسل فورير أحد أهم أدوات التحليل الرياضي، و كانت ثمرة أعمال العالم الفرنسي جوزيف فورييه   Joseph Fourier تقديرا لأعماله الفذة في السلاسل المثلثية، تحديدا في حله لمعادلة الحرارة.
 ...
 نفترض فيما يلي أن الدالة $f$ قابلة للمكاملة على المجال $]-L,L[$، و لتكن دورية ذات دور $2L$، اي أن $f(x+2kL)=f(x), \forall k\in\mathbb{Z}$
...
$$a_n=\frac{2}{L}\int_{0}^Lf(x)\cos(\frac{n\pi x}{L})dx,\quad \forall n\geq 1$$
